...
public class RestaurantBrowser extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        restaurantFragmentRow = new RestaurantFragmentList();
        adapter = new FragmentAdapter(fragmentManager, restaurantFragmentRow, "Restaurant");
    ...
    private void refreshList() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                restaurantFragmentRow = new RestaurantFragmentList();
                FragmentAdapter adapter = new FragmentAdapter(getSupportFragmentManager(), restaurantFragmentRow, "Restaurant");
                viewPager.setAdapter(adapter);
            }
        }, 3000);
    }
