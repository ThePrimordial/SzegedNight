 ...
 */
public class AtmBrowser extends AppCompatActivity {
    ...
    private AtmFragmentList atmFragmentRow;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        atmFragmentRow = new AtmFragmentList();
        adapter = new FragmentAdapter(fragmentManager, atmFragmentRow, "ATM");
        ...
        helper = new ProgressHelper(fabProgressCircle,this);
        fabProgressCircle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                trans.remove(atmFragmentRow);
                trans.commit();
                refreshList();
                fabProgressCircle.resetIcon();
